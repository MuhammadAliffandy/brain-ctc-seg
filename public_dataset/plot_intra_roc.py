...
def main():
    ...
    OUT_FILE = os.path.expanduser("~/Clara/brain-ctc-seg/training/Journal_Figures/ROC_Curve_Public_IntraDomain.png")
    
    if not os.path.exists(CSV_PATH):
        print(f"❌ Error: File {CSV_PATH} tidak ditemukan.")
        print(f"Pastikan Anda sudah menjalankan train_all_intra.py terlebih dahulu!")
        return
    ...
    plt.title(f'ROC Curve - Kaggle Stroke Dataset (Intra-Domain)', fontsize=16, fontweight='bold', pad=20)
    ...
    print(f"✅ Kurva ROC Intra-Domain berhasil digenerate!")
