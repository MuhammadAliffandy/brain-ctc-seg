...
python train_ablation.py --variant A2 --dataset ct --se2 1 --slices 1 --loss focal_dice
# A3: SE2=0, 2.5D=3, Boundary=0
python train_ablation.py --variant A3 --dataset ct --se2 0 --slices 3 --loss focal_dice
# A4: SE2=0, 2.5D=1, Boundary=1
python train_ablation.py --variant A4 --dataset ct --se2 0 --slices 1 --loss focal_dice_boundary
# A5: SE2=1, 2.5D=3, Boundary=0
python train_ablation.py --variant A5 --dataset ct --se2 1 --slices 3 --loss focal_dice
# A6: SE2=1, 2.5D=1, Boundary=1
python train_ablation.py --variant A6 --dataset ct --se2 1 --slices 1 --loss focal_dice_boundary
# A7: SE2=0, 2.5D=3, Boundary=1
python train_ablation.py --variant A7 --dataset ct --se2 0 --slices 3 --loss focal_dice_boundary
# A8: SE2=1, 2.5D=3, Boundary=1 (Full CT-SE2)
python train_ablation.py --variant A8 --dataset ct --se2 1 --slices 3 --loss focal_dice_boundary


# -------------------------------------------------------------
# TABLE 2: LOSS CONFIGURATION (SE2=1, 2.5D=3)
# -------------------------------------------------------------
python train_ablation.py --variant Loss_DiceOnly --dataset ct --se2 1 --slices 3 --loss dice
python train_ablation.py --variant Loss_FocalDice --dataset ct --se2 1 --slices 3 --loss focal_dice
python train_ablation.py --variant Loss_DiceBound --dataset ct --se2 1 --slices 3 --loss dice_boundary
...
# 5-slice:
python train_ablation.py --variant Context_5D --dataset ct --se2 1 --slices 5 --loss focal_dice_boundary
